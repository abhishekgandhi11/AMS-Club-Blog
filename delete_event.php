  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <a>You can See All Event and Delete Event From Here..!</a>
          ...
          <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                ...
                <input type="text" class="form-control" placeholder="Event id" name="post_id" id="post_id">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-danger" name="delete_p" >Delete event</button>
              <button type="submit" class="btn btn-danger" formaction="existing_event.php" name="e_event" >Existing event</button>
            </div>
            <br>
          </form>
          <?php
                ...
                if(isset($_POST["delete_p"])){
                    $p_id = $_POST["post_id"];
                    $sql2 = "delete from event where event_id = $p_id";
                     if($conn->query($sql2)===TRUE){
                        echo "<div class='alert alert-success'>";
                            echo "<strong>Congratulation...! </strong> Event is Deleted.";
                        echo "</div>";

                     }
                     else{
                        echo "<div class='alert alert-danger'>";
                            echo "<strong>Alert..! </strong> Event is not Deted";
                        echo "</div>";
                     }
                }
