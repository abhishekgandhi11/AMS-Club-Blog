...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <p>List of Existing President of AMS</p><hr>
          <!-- Contact Form - Enter your email address on line 19 of the mail/contact_me.php file to make this form work. -->
          <!-- WARNING: Some web hosts do not allow emails to be sent through forms to common mail hosts like Gmail or Yahoo. It's recommended that you use a private domain email address! -->
          <!-- To use the contact form, your site must be on a live web host with PHP! The form will not work locally! -->
          <?php
                require_once('connect.php');
                $sql = "select * from existing_user order by e_id desc";
                    $result = $conn->query($sql);
                        while($row = $result->fetch_assoc()){
                            echo "President name :    " . $row["e_name"] ."";
                            echo "Email id  :    " . $row["email_id"] . "";
                            echo "Work Complete Date  :   " .  $row["date"] . "<br>";
                            echo " Working Year  :   " . $row["year"]. "<br>";
                            echo "<br>";
                            echo "<hr>";
                    }
            ?>
