  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <a>Feed Back from Students..!</a><br><br><hr><hr>
                ...
                $cnt=1;
                    $result = $conn->query($sql);
                        while($row = $result->fetch_assoc()){
                            echo "Feedback Id   :   ".$row["f_id"] ."<br>";
                            echo "Feedback title :    " . $row["f_title"] ."<br>";
                            echo "Feedback  :    " . $row["f_detail"] . "<br>";
                            echo "Feedback Date  :   " .  $row["f_date"] . "<br>";
