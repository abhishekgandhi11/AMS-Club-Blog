      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="feedback.php">Sample Post</a>
            </li>
            <li class="nav-item">
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <form name="sentMessage"  method="post">
            ...
            <div class="form-group floating-label-form-group controls">
                ...
                <input type="password" class="form-control" placeholder="Password" name="pwd" id="pwd" required data-validation-required-message="Please enter Password.">
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <br>
            ...
            <?php                         
                if(isset($_POST["submit"])){
                    ...
                    $pass = $_POST['pwd'];
                    $sql = "select * from user_info where email_id='$email_id' and user_password='$pass'";
                    $res = $conn->query($sql);
                    if($res->num_rows==1){
                        $row = $res->fetch_assoc();
                        if($row["user_type"]=='admin'){
                          ...
                          //$_SESSION["user_name"] = $row["user_name"];
                          echo "President";
                          header('Location: ams_post.php');
                        }
                    }
                    else{
                      echo "<div class='alert alert-danger'>";
                            echo "<strong>Alert..!</strong> Your Email Id or Password May be incorrect, Please Enter Correct one.";
                        echo "</div>";
                    }
                }
            ?>
